...
*/
    ...
    private void gotoMyLocation(double lat, double lng, float bearing) {
        ...
        if (mMap != null) {
            ...
            if (enableNewLocationAddToPolyline = true) {// Όταν δηλαδή δεν
                // δημιουργείται ένα
                // polyline με τις
                // παλιές θέσεις του
                // χρήστη
                rectOptions.add(new LatLng(lat, lng));// Προσθέτει την καινούγια
                // θέση του χρήστη
                polyline = mMap.addPolyline(rectOptions);// Και την
                // εμφανίζει εδώ
            }
